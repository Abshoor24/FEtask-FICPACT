      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
          ...
          <div className="relative flex justify-center">
            {/* Glow rings */}
            <div className="absolute h-72 w-72 rounded-full bg-green-100 opacity-40" />
            <div className="absolute h-96 w-96 rounded-full bg-green-200 opacity-30" />
            ...
            {/* Level Badge */}
            <div className="absolute right-4 top-6 rounded-xl bg-white px-4 py-2 text-xs font-medium shadow">
              🌱 Level 4 Garden
            </div>

            {/* Toast */}
            <div className="absolute -bottom-6 left-1/2 w-64 -translate-x-1/2 rounded-xl bg-white px-4 py-3 text-xs shadow-lg">
          ...
          <div>
            ...
            <p className="mb-10 max-w-xl text-gray-600">
              Visualizing progress is key to student success. Watch your
              virtual garden flourish as you maintain your streaks.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Every task completed adds a ray of sunshine. Reach the
                    7-day “Golden Hour” for bonus rewards.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Friendly reminders where you already hang out — no
