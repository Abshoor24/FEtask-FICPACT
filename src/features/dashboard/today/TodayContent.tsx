      ...
      <div className="h-full overflow-y-auto px-4 md:px-10 py-6 md:py-8">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full md:w-auto">
            {/* SEARCH */}
            <div className="flex w-full sm:w-auto sm:flex-1 h-10 shrink-0 items-center gap-2 rounded-xl border border-gray-200 bg-white px-3 text-sm text-gray-500 shadow-sm focus-within:border-purple-300 focus-within:ring-2 focus-within:ring-purple-100 transition-all">
