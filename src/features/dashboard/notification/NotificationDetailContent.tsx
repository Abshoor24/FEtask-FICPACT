      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="p-6 space-y-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-emerald-700 mt-1">
                    Quest berhasil diselesaikan. Terus pertahankan momentum-mu!
                  </p>
                </div>
              </div>
            </div>
          ...
          {notification.type === "QUEST_FAILED" && (
            <div className="mt-4 p-5 rounded-xl bg-gradient-to-r from-red-50 to-rose-50 border border-red-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-red-700 mt-1">
                    Jangan menyerah! Evaluasi apa yang bisa diperbaiki dan coba
                    lagi.
                  </p>
                </div>
              </div>
