...
class RefelectionService {
    public async createUserReflection(data: CreateUserReflection): Promise<{data: CreateUserReflection}> {
    ...
    public async createUserFailed(data: UserFailedReflection): Promise<{data: UserFailedReflection}> {
